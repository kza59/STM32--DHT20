...
#define LCD0_Pin GPIO_PIN_6
#define LCD0_GPIO_Port GPIOA
#define LCD1_Pin GPIO_PIN_7
#define LCD1_GPIO_Port GPIOA
#define LCD2_Pin GPIO_PIN_4
#define LCD2_GPIO_Port GPIOC
#define LCD3_Pin GPIO_PIN_5
...
#define DHT20_EN_Pin GPIO_PIN_9
#define DHT20_EN_GPIO_Port GPIOB
